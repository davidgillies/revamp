...
@register.inclusion_tag('revamp_tool/top_menu.html', takes_context=True)
def top_menu(context, parent, calling_page=None):
    menuitems = parent.get_children().live().in_menu()
    print("menuitems: %s" % menuitems)
...
@register.inclusion_tag('revamp_tool/top_menu_children.html', takes_context=True)
...
@register.inclusion_tag('revamp_tool/breadcrumbs.html', takes_context=True)
